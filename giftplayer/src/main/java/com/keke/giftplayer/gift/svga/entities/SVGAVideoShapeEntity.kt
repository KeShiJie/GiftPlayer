package com.keke.giftplayer.gift.svga.entities

import android.graphics.Color
import android.graphics.Matrix
import android.graphics.Path
import android.graphics.RectF
import com.keke.giftplayer.gift.svga.entities.SVGAPathEntity
import com.keke.giftplayer.gift.svga.proto.ShapeEntity
...
internal class SVGAVideoShapeEntity {
    ...
    // Checks whether color values are in [0f, 1f] or [0f, 255f].
    ...
    // Checks whether alpha is in [0f, 1f] or [0f, 255f].
    ...
    private fun checkAlphaValueRange(color: ShapeEntity.ShapeStyle.RGBAColor): Float {
        return if (color.a == null || color.a <= 1f) {
            255f
        } else {
            1f
        }
