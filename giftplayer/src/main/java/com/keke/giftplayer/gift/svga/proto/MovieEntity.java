...
public final class MovieEntity extends Message<MovieEntity, MovieEntity.Builder> {
  ...
  @WireField(
      tag = 2,
      adapter = "com.keke.giftplayer.gift.svga.proto.MovieParams#ADAPTER"
  )
  public final MovieParams params;

  /**
   * Key is the bitmap key name, and value is the bitmap file name or binary PNG data.
   */
  @WireField(
      tag = 3,
  ...
  @WireField(
      tag = 4,
      adapter = "com.keke.giftplayer.gift.svga.proto.SpriteEntity#ADAPTER",
  ...
  @WireField(
      tag = 5,
      adapter = "com.keke.giftplayer.gift.svga.proto.AudioEntity#ADAPTER",
      label = WireField.Label.REPEATED
  )
