...
public final class FrameEntity extends Message<FrameEntity, FrameEntity.Builder> {
  ...
  @WireField(
      tag = 2,
      adapter = "com.keke.giftplayer.gift.svga.proto.Layout#ADAPTER"
  )
  ...
  /**
   * Matte path. Uses the standard SVG Path format to draw the mask shape.
   */
  @WireField(
      tag = 4,
  ...
  @WireField(
      tag = 5,
      adapter = "com.keke.giftplayer.gift.svga.proto.ShapeEntity#ADAPTER",
